...
public class RoomDaoImpl_Galaxy extends BaseDao implements RoomDao_Galaxy {
    ...
    public Room_Galaxy select_Galaxy(String rNum) {
        Room_Galaxy room_galaxy = new Room_Galaxy();
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
    ...
    public void setrState(String rNum) {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
    ...
    public boolean isRNum(String rNum) {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        String sql = "select * from `room`";
    ...
    public void add_Galaxy(Room_Galaxy room_galaxy) {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
    ...
    public void edit_Galaxy(Room_Galaxy room_galaxy) {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
    ...
    public void del_Galaxy(String rNum) {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
